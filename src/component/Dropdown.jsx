...
import pic2 from '../assets/Public1.svg';
import pic3 from '../assets/Public2.svg';
...
const Dropdown = () =>{
    return(
        ...
        <div class=" h-120 bg-sky-50">
            <img class="w-150 h-90 rounded-3xl shadow-2xl absolute left-159 mt-4" src={pic1}/>
            <div class="absolute left-25 top-80 text-2xl">
                <p class="text-gray-700"> Our Health<span class="text-yellow-500 font-bold pl-3">Our Future</span></p>
                <p class="text-blue-500">Medical</p>
            </div>
